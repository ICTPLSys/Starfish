...
#include "cache/core/design1/placement_policy.hpp"
#include "cache/core/design1/runtime_types.hpp"
...
public:
    ...
    void post_rdma_request(far_obj_t obj, size_t client_idx,
        ...
        if constexpr (IsReadRequest) wc_object_diag::prepost(obj.obj_id, wr_id);
...
public:
    ConcurrentArrayCache(void *local_buf, size_t local_buf_size,
        ...
        if (config.enable_region_hotness_placement) {
    ...
    std::pair<far_obj_t, void *> allocate(FarObjectEntry *entry, size_t size,
        ...
        if (::FarLib::get_config().exclusive_cache) {
            ...
            remote_ptr = allocate_remote(size);
        }
...
#include "cache/core/design1/diagnostics.ipp"
#include "cache/core/design1/fetch_placement.ipp"
#include "cache/core/design1/placement_planner.ipp"
